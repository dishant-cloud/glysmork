    ...
    const PRESET_CATEGORIES = [
        {
            ...
            avatars: [
                { url: 'https://api.dicebear.com/7.x/adventurer/png?seed=Lion&backgroundColor=fef3c7&size=300', label: 'Lion' },
                { url: 'https://api.dicebear.com/7.x/adventurer/png?seed=Wolf&backgroundColor=e0e7ff&size=300', label: 'Wolf' },
                { url: 'https://api.dicebear.com/7.x/adventurer/png?seed=Fox&backgroundColor=fee2e2&size=300', label: 'Fox' },
                { url: 'https://api.dicebear.com/7.x/adventurer/png?seed=Bear&backgroundColor=d1fae5&size=300', label: 'Bear' },
                { url: 'https://api.dicebear.com/7.x/adventurer/png?seed=Eagle&backgroundColor=e0f2fe&size=300', label: 'Eagle' },
                { url: 'https://api.dicebear.com/7.x/adventurer/png?seed=Owl&backgroundColor=f3e8ff&size=300', label: 'Owl' },
                { url: 'https://api.dicebear.com/7.x/adventurer/png?seed=Tiger&backgroundColor=fff7ed&size=300', label: 'Tiger' },
                { url: 'https://api.dicebear.com/7.x/adventurer/png?seed=Dolphin&backgroundColor=cffafe&size=300', label: 'Dolphin' },
            ]
        },
        {
            id: 'characters',
            ...
            avatars: [
                ...
                { url: 'https://api.dicebear.com/7.x/lorelei/png?seed=Storm&backgroundColor=e0f2fe&size=300', label: 'Storm' },
                { url: 'https://api.dicebear.com/7.x/lorelei/png?seed=Nova&backgroundColor=f0fdf4&size=300', label: 'Nova' },
                { url: 'https://api.dicebear.com/7.x/micah/png?seed=Raven&backgroundColor=1e1b4b&hair=fonze&hairColor=f9a8d4&size=300', label: 'Raven' },
                { url: 'https://api.dicebear.com/7.x/micah/png?seed=Kai&backgroundColor=0f172a&hair=full&hairColor=7dd3fc&size=300', label: 'Kai' },
                { url: 'https://api.dicebear.com/7.x/micah/png?seed=Zara&backgroundColor=064e3b&hair=dannyPhantom&hairColor=fde68a&size=300', label: 'Zara' },
                { url: 'https://api.dicebear.com/7.x/micah/png?seed=Orion&backgroundColor=1c1917&hair=mrT&hairColor=a5f3fc&size=300', label: 'Orion' },
            ]
        },
        {
            id: 'artistic',
            ...
            avatars: [
                ...
                { url: 'https://api.dicebear.com/7.x/rings/png?seed=Aurora2&backgroundColor=1a1500&size=300', label: 'Aurora' },
                { url: 'https://api.dicebear.com/7.x/identicon/png?seed=Matrix&backgroundColor=0a0a0a&size=300', label: 'Matrix' },
                { url: 'https://api.dicebear.com/7.x/identicon/png?seed=Cipher&backgroundColor=0a0a0a&size=300', label: 'Cipher' },

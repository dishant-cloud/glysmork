    ...
    return (
        <div className="min-h-screen bg-white text-slate-700">
            <div className="max-w-3xl mx-auto px-6 py-12">
                ...
                <p className="text-sm text-slate-400 mb-10 font-sans text-[13px] font-medium">Last updated: April 13, 2026</p>

                <div className="space-y-8 leading-relaxed text-sm text-slate-600">
                    <section>
                        <h2 className="text-xl font-semibold text-slate-900 mb-3">1. Acceptance of Terms</h2>
                        <p>By creating an account on Glysmork, you agree to these Terms of Service and our <Link href="/privacy" className="text-indigo-600 hover:text-indigo-500 underline">Privacy Policy</Link>. If you do not agree, do not use the platform.</p>
                    </section>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-slate-900 mb-3">3. Account Requirements</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-slate-900 mb-3">4. Free Usage Limits &amp; Quotas</h2>
                        <p className="mb-3">Free accounts are subject to the following daily usage limits, which reset at midnight UTC:</p>
                        <ul className="list-disc ml-6 space-y-2">
                            <li><strong className="text-slate-800">AI/Intent-based Search:</strong> Up to 4 searches per day (combined). This limit applies to all searches that involve calling an external AI/LLM service, including onboarding-profile-aware searches.</li>
                            <li><strong className="text-slate-800">Roulette Matching:</strong> Up to 20 random matches per day.</li>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-slate-900 mb-3">5. Subscription Plans &amp; Billing</h2>
                        <p className="mb-3">Glysmork offers the following paid subscription tiers, providing extended daily limits:</p>
                        <ul className="list-disc ml-6 space-y-2">
                            <li><strong className="text-slate-800">Subscribed tier limits:</strong> Up to 40 LLM-based AI searches per day; up to 100 standard (non-LLM) searches per day; unlimited Roulette matches.</li>
                            ...
                            <li><strong className="text-slate-800">Refund Policy:</strong> Subscriptions are non-refundable once activated. If you experience a billing issue, contact <span className="text-indigo-600 font-medium">billing@glysmork.com</span> within 7 days of purchase.</li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-xl font-semibold text-slate-900 mb-3">6. AI Data Processing &amp; Profile Analysis</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-slate-900 mb-3">9. Reporting &amp; Moderation</h2>
                        <ul className="list-disc ml-6 space-y-2">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-slate-900 mb-3">11. Service Availability &amp; Uptime</h2>
                        <ul className="list-disc ml-6 space-y-2">
                    ...
                    <section>
                        ...
                        <p>For questions about these terms, contact us at <span className="text-indigo-600 font-medium">legal@glysmork.com</span>. For billing issues, contact <span className="text-indigo-600 font-medium">billing@glysmork.com</span>.</p>
                    </section>
                </div>

                <div className="mt-16 pt-8 border-t border-slate-200 text-center">
                    <Link href="/privacy" className="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Privacy Policy</Link>
